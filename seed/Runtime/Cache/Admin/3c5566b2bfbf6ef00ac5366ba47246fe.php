...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>SEED種子音樂管理系統</title>
        <link rel="stylesheet" type="text/css" href="/ob/seed/Public/Admin/css/login.css" media="all">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>SEED種子音樂管理系統</h3>
